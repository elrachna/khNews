...
const Religion = () => {
  return (
    <div>
      ...
      <div className="grid grid-cols-3 md:grid-rows-1 md:grid-cols-2 gap-2 mt-4">
        {/* Big Card */}
        {datas.map(
          (data, index) =>
            index === 0 && (
              <div
                key={index}
                className="grid col-span-2 md:col-span-1 rounded-lg text-white shadow-lg relative"
              >
                <Image
                  width={400}
                  height={400}
        ...
        {/* Small Card */}
        <div className="grid md:grid-rows-2  md:grid-cols-2 gap-2">
          {datas.map(
            (data, index) =>
              index > 0 &&
              index < 3 && (
